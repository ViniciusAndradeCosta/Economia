...
const saibaBtn = document.querySelector('.saiba-btn');
...
function showResultBox() {
    ...
    scoreText.textContent = `Seu Score foi ${userScore}/${questions.length}`;
    ...
    let progress = setInterval(() => {
        ...
        circularProgress.style.background = `conic-gradient(#2aa051 ${progressStartValue * 3.6}deg, rgba(255, 255, 255, .1) 0deg)`;
